...
var portraitToLandscapeTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingElIsCardModal) {
    ...
    }).fromTo("transform", fromTransform, toTransform).fromTo("filter", "contrast(0.85)", "contrast(0.85)");
    const shadowAnimation = createAnimation().addElement(presentingElRoot.querySelector(".modal-shadow")).afterStyles({
      transform: toTransform
    }).fromTo("opacity", "0", "0").fromTo("transform", fromTransform, toTransform);
    baseAnimation.addAnimation([presentingAnimation, shadowAnimation]);
  }
  return baseAnimation;
};
var landscapeToPortraitTransition = (baseEl, opts, duration = 300) => {
  ...
  if (!presentingElIsCardModal) {
    ...
    presentingAnimation.addElement(presentingEl).beforeStyles({
      transform: "translateY(0px) scale(1)",
      "transform-origin": "top center",
      overflow: "hidden"
    }).afterStyles({
...
var Modal = class {
  ...
  render() {
    ...
    return h(Host, Object.assign({
      key: "1980fa23331381c568a2be8091d888e09754fc52",
      "no-router": true,
      ...
      */
      ...
      key: "0180a4d6952e41bfd736272d1a49d47d86ca7fef",
      class: "modal-handle",
    ...
    }), h("slot", { key: "d062f330675f730ad70c23267baed200ca9b43b0" })));
  }
  get el() {
...
@ionic/core/dist/esm/ion-modal.entry.js:
   ...
   *)
*/
//# sourceMappingURL=ion-modal.entry-WIN77XU5.js.map
